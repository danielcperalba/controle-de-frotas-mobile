...
export default function PreventivaCard() {
    const manutencaoPreditiva = {
        tipoManutencao: "Manutenção Preventiva",
        data: "15/04/2024",
        servico: "Substituição da bateria",
        descricao: "Realizada a troca de óleo do motor e do filtro de óleo. Verificada as condições das correias e dos pneus.",
        dataRetorno: "15/10/2024"
    };
